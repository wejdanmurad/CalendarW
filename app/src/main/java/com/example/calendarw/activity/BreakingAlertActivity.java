...
public class BreakingAlertActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_breaking_alert);
        ...
        tb_txt.setText(getResources().getString(R.string.AppLock));
